...
export default class App extends React.Component<AppProps, AppState> {
  ...
  replaceRange: (documentRange: Word.ContentControl, markup: string) => Word.ContentControl = (documentRange: Word.ContentControl, markup: string) => {
  ...
  constructor(props, context) {
    ...
    this.citationManager = new CitationManager<Word.ContentControl>(this.replaceRange);
		this.citationManager.addCitable(new Journal({
      ...
      <div className="ms-welcome">
        <FluentProvider theme={this.state.theme == "light" ? teamsLightTheme : teamsDarkTheme}>
          <main className="ms-welcome__main" style={{alignItems: "flex-start"}}>
            <Pane settingProps={{settings: this.state.settings, onSettingsChange: ()=>{}}}
